$(document).ready(function() {
        ...
        if (matches.length === 0) {
            suggestionsBox.addClass('active').html(`
                <div class="no-results">
                    <i class="fas fa-search"></i> No airlines found
                </div>
            `);
            return;
        }
    ...
    $(document).on('click', '.suggestion-item', function() {
        ...
        // Scroll to and highlight matching card
    ...
    $(document).on('keydown', function(e) {
        ...
        if (!suggestionsBox.hasClass('active') || items.length === 0) return;
